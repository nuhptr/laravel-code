            ...
            <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                ...
                <div
                    ...
                    <div
                        ...
                        <button
                            class="btn-fill border-white font-normal text-white text-base py-4 px-6 rounded-xl bg-transparent rounded hover:border-transparent"
                            style="font-family: 'Poppins', sans-serif; background : #3e3e69">
                            <div class="flex items-center">
                                <img style="height: 20px;" class="mr-2" src={{ asset('assets/icon-1.png') }} alt="" />
                                Tables
                            </div>
                        </button>
                    </div>
                ...
                <div class="w-full lg:w-1/2 text-center justify-center flex pr-0">
                    <img id="hero-header-2-3" src={{ asset("assets/hero-1.svg") }} alt="" />
                </div>
            </div>
        </div>
    </div>
